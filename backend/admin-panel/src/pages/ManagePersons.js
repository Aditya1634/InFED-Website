...
const ManagePersons = () => {
  ...
  useEffect(() => {
    const fetchPersons = async () => {
      try {
        const response = await fetch("https://infed-website.onrender.com/api/people");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = personId
        ? `https://infed-website.onrender.com/api/update-person/${personId}`
        : "https://infed-website.onrender.com/api/add-person";
  ...
  const deletePerson = async (id) => {
    try {
      const response = await fetch(`https://infed-website.onrender.com/api/delete-person/${id}`, {
        method: "DELETE",
      });
      const data = await response.json();
      if (response.ok) {
